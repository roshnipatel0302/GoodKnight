        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-display font-bold">Good Knight</span>
            </Link>
            <p className="text-primary-100 mb-4 max-w-sm">
              Protecting families with safe, effective mosquito repellent solutions. 
              Sleep peacefully, stay protected.
            </p>
        ...
        <div className="pt-8 border-t border-primary-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-primary-200 text-sm">
              © {new Date().getFullYear()} Good Knight. All rights reserved.
            </p>
